...
This module provides functions using Raku's B<Proc> class.  
Two of the most noteworthy ones are:

=item C<run-command>
=item C<time-command>

This module uses the GNU C<time> command (usually installed as
